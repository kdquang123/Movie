...
public class MemberCreateCommandHandler : UserBaseHandler, IRequestHandler<MemberCreateCommand, bool>
{
    private readonly IEmailService _emailService;

    public MemberCreateCommandHandler(IEmailService emailService, UserManager<User> userManager, RoleManager<Role> roleManager, IUnitOfWork unitOfWork, IMapper mapper) : base(userManager, roleManager, unitOfWork, mapper)
    {
        _emailService = emailService;
    }

    public async Task<bool> Handle(MemberCreateCommand request, CancellationToken cancellationToken)
    {
